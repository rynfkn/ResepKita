        ...
        NavHost(
            ...
            composable("search") {
                SearchScreen(
                    ...
                    selectedDifficulty = viewModel.searchDifficulty,
                    onDifficultyChange = { viewModel.updateSearchDifficulty(it) },
                    selectedMaxTimeMinutes = viewModel.searchMaxTimeMinutes,
                    onMaxTimeChange = { viewModel.updateSearchMaxTime(it) },
                    selectedMinRating = viewModel.searchMinRating,
                    onMinRatingChange = { viewModel.updateSearchMinRating(it) },
                    favoritesOnly = viewModel.searchFavoritesOnly,
                    onFavoritesOnlyChange = { viewModel.updateSearchFavoritesOnly(it) },
